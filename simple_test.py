...
def test_risk_patterns():
    ...
    for text, description in test_cases:
        ...
        print(f"  Rules: {', '.join(assessment.triggered_rules) if assessment.triggered_rules else 'None'}")
...
def test_risk_endpoint():
    ...
    for text in test_texts:
        ...
        print(f"  Rules: {', '.join(result['triggered_rules']) if result['triggered_rules'] else 'None'}")
