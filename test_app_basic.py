...
class TestPatternDetection:
    ...
    def test_email_detection(self):
        result = pattern_detector.assess_compliance_risk("Contact me at john.doe@example.com")
...
class TestRiskAssessment:
    ...
    def test_assess_risk_email(self, client):
        response = client.post("/assess-risk", params={"text": "My email is test@example.com"})
        assert response.status_code == 200
        data = response.json()
